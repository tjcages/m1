...
import { EffectComposer, SSR, Bloom, ChromaticAberration } from '@react-three/postprocessing'
...
export function Effects() {
  ...
  return (
    <EffectComposer disableNormalPass={false}>
      {/* <SSR {...props} />
      <Bloom luminanceThreshold={7} mipmapBlur luminanceSmoothing={1} intensity={0.2} /> */}
      {/* <LUT lut={texture} /> */}
